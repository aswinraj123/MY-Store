...
class Productview(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = ProductSerializer(qs, many=True)         # deserializing
...
class CartsView(viewsets.ModelViewSet):
    ...
    # def list(self, request, *args, **kwargs):
    #
    #     qs = request.user.carts_set.all()                     #def get_queryset(self):
    #     serializer = CartSerializer(qs, many=True)            # return Carts.objects.filter(user=self.request.user)
    #     return Response(data=serializer.data)
